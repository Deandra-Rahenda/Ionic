...
export class HomePage {
  ...
  wanumber: string = "81297825214";
  whatsappUrl: string = "https://wa.me/";
  telegramUrl: string = "https://t.me/";
  email: string = "if21.deandrarahenda@mhs.ubpkarawang.ac.id";

  name: string = "";
  nim: string = "";
  class: string = "";
  message: string = "";
  sendTo: string = "whatsapp";
  telegramUsername: string = "Deandra_Rahenda";
  ...
  sendMessage() {
    ...
    if (this.sendTo === "whatsapp") {
      const whatsappMessage = `Hi, Nama Saya ${this.name}. NIM: ${this.nim}. Kelas: ${this.class}. ${this.message}`;
      ...
      const telegramMessage = `Hi, Nama Saya ${this.name}. NIM: ${this.nim}. Kelas: ${this.class}. ${this.message}`;
